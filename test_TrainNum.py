...
TrainNum, poly_deg = 5000, 2
for model_name, data_name, redshit in zip(model_names, data_files, redshift_range):
    model_name = model_name + f'_PolyDeg={poly_deg}_TrainNum={TrainNum}'
    training_model(data_name, model_name, redshit, poly_deg=poly_deg, egien_num=10, num_train=TrainNum)

TrainNum, poly_deg = 10000, 2
for model_name, data_name, redshit in zip(model_names, data_files, redshift_range):
    model_name = model_name + f'_PolyDeg={poly_deg}_TrainNum={TrainNum}'
    training_model(data_name, model_name, redshit, poly_deg=poly_deg, egien_num=10, num_train=TrainNum)

TrainNum, poly_deg = 20000, 2
for model_name, data_name, redshit in zip(model_names, data_files, redshift_range):
    model_name = model_name + f'_PolyDeg={poly_deg}_TrainNum={TrainNum}'
    training_model(data_name, model_name, redshit, poly_deg=poly_deg, egien_num=10, num_train=TrainNum)